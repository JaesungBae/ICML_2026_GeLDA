...
In the first and second stages, where pre-training the SER model and diffusino model for augmentation, following training datsaet is used: $\mathcal{D}^{\setminus \kappa}\cup \tilde{\mathcal{D}}^{(\kappa)}$. 
