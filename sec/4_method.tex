\begin{wrapfigure}[17]{r}{0.4\textwidth}
  \centering
  \vspace{-0.35in}
  \includegraphics[width=\linewidth]{figs/SER-pipeline.pdf}\vspace{-0.07in}
...
\subsection{On the choice of a proper latent representation layer} 
